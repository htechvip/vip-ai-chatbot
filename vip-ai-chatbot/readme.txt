...
1. Install and activate the VIP AI CHATBOT plugin.
2. Go to website home page to see it in action.

Now your website visitors can enjoy a seamless and personalized chat experience powered by OpenAI's ChatGPT API.

== Installation ==

1. Upload the 'vip-ai-chatgpt' folder to the '/wp-content/plugins/' directory.
...
1. Initial VIP AI CHATBOT display
2. Ask VIP AI CHATBOT any question
3. Get a response from VIP AI CHATBOT
4. Settings and Options
5. Mobile Experience - Initial VIP AI CHATBOT display
6. Mobile Experience - Ask Chatbot ChatGTP any question
7. Mobile Experience - Get a response from VIP AI CHATBOT
8. Mobile Experience - VIP AI CHATBOT minimize (Lower Right)
