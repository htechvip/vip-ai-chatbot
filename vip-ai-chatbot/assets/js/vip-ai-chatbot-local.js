jQuery(document).ready(function ($) {
    ...
    function vip_ai_chatbot_localize() {
        // Access the variables passed from PHP using the chatbotSettings object - Ver 1.4.1
        var chatgptName = (typeof chatbotSettings !== 'undefined' && chatbotSettings.chatgpt_bot_name) ? chatbotSettings.chatgpt_bot_name : 'VIP AI CHATBOT';
        var chatgptInitialGreeting = (typeof chatbotSettings !== 'undefined' && chatbotSettings.initial_greeting) ? chatbotSettings.initial_greeting : 'Hello! I can answer anything related to this website. How can I help?';
        var chatgptSubsequentGreeting = (typeof chatbotSettings !== 'undefined' && chatbotSettings.chatgpt_subsequent_greeting) ? chatbotSettings.chatgpt_subsequent_greeting : 'Hello again! Need help?';
